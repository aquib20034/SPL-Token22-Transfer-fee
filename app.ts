...
const payer = loadWalletKey("6Ud1Kcq6okgdmQy6phzvQEiuuNHALPnk9b5GVpqqkTsS.json");


const mintAuthority =  loadWalletKey("6Ud1Kcq6okgdmQy6phzvQEiuuNHALPnk9b5GVpqqkTsS.json");
const mintKeypair =  Keypair.generate();
const mint = mintKeypair.publicKey;

// Generate keys for transfer fee config authority and withdrawal authority
const transferFeeConfigAuthority = loadWalletKey("6Ud1Kcq6okgdmQy6phzvQEiuuNHALPnk9b5GVpqqkTsS.json");
const withdrawWithheldAuthority = loadWalletKey("6Ud1Kcq6okgdmQy6phzvQEiuuNHALPnk9b5GVpqqkTsS.json");
...
const mintAmount = BigInt(1_000_0 * Math.pow(10, decimals)); // Mint 1,000,000 tokens
...
async function main() {
    ...
    // await connection.confirmTransaction({ signature: airdropSignature, ...(await connection.getLatestBlockhash()) });
        ...
        const owner = loadWalletKey("6Ud1Kcq6okgdmQy6phzvQEiuuNHALPnk9b5GVpqqkTsS.json");
        ...
        const feeVault = loadWalletKey("6Ud1Kcq6okgdmQy6phzvQEiuuNHALPnk9b5GVpqqkTsS.json");
